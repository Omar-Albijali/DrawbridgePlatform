...
export default function Security(): JSX.Element {
  ...
  const isPasswordValid =
    ...
    Boolean(passwords.new) &&
    Boolean(passwords.confirm) &&
      ...
      <div className="card">
        ...
        <div className="space-y-4 max-w-md">
          ...
          <button
            ...
            className={`btn-primary px-6 py-2.5 mt-2 flex items-center gap-2 ${
              !isPasswordValid || isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
            }`}
          >
